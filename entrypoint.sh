...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/6d736db4-6211-469a-b7fe-010bb0e29431"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="6d736db4-6211-469a-b7fe-010bb0e29431"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/82d57390-2cb0-4815-ab13-69515b281cd1"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="82d57390-2cb0-4815-ab13-69515b281cd1"
fi
echo ${Vmess_UUID}
